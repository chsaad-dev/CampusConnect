...
import com.campusconnect.databinding.FragmentBloodRequestDetailBinding
...
@AndroidEntryPoint
class BloodRequestDetailFragment : Fragment() {

    private var _binding: FragmentBloodRequestDetailBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBloodRequestDetailBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.loadDetails(postId, PostType.BLOOD)
                ...
                viewModel.bloodRequestDetails.collectLatest { state ->
                    when (state) {
                        ...
                        is Resource.Success -> {
                            ...
                            binding.tvBloodGroup.text = details.bloodGroup.takeIf { it.isNotEmpty() } ?: "??"
                            binding.tvUrgency.text = details.urgency.takeIf { it.isNotEmpty() } ?: "Normal"
